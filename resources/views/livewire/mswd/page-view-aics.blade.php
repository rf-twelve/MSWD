        ...
        <x-topbar-desktop>
            ...
            <li class="flex">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('aics-list',['user_id'=>auth()->user()->id]) }}" class="ml-4 text-sm font-medium text-white hover:text-blue-200">
                        Aics List
                    </a>
                </div>
            </li>
                            ...
                            <div class="border-t border-gray-200">
                                <ul role="list" class="divide-y divide-gray-200">
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">aics no :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['aics_no'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">claimant :</h3>
                                                <p class="text-sm text-gray-500">
                                                    {{
                                                        $data->claimant['first_name'].' '.
                                                        $data->claimant['middle_name'].' '.
                                                        $data->claimant['last_name']
                                                    }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">beneficiary :</h3>
                                                <p class="text-sm text-gray-500">
                                                    {{
                                                        $data->beneficiary['first_name'].' '.
                                                        $data->beneficiary['middle_name'].' '.
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">relation :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['relation'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">assistance type :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['assistance_type'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">amount :</h3>
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">amount type :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['amount_type'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">worker :</h3>
                                                <p class="text-sm text-gray-500">{{$data->worker['fullname']}}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">prepared by :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['prepared_by'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">

        ...
        <x-topbar-desktop>
            ...
            <li class="flex">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('client-list',['user_id'=>auth()->user()->id]) }}" class="ml-4 text-sm font-medium text-white hover:text-blue-200">
                        Client List
                    </a>
                </div>
            </li>
                            ...
                            <div class="border-t border-gray-200">
                                <ul role="list" class="divide-y divide-gray-200">
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">first_name :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['first_name'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">middle_name :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['middle_name'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">last_name :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['last_name'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">gender :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['gender'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">photo :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['photo'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">category :</h3>
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">lot_blk_no :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['lot_blk_no'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">street :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['street'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">barangay :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['barangay'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">contact :</h3>
                                                <p class="text-sm text-gray-500">{{ $data['contact'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">email :</h3>
                                    ...
                                    <li class="py-4">
                                        <div class="flex space-x-3">
                                            <div class="flex-1 space-y-1">
                                                <h3 class="text-sm font-medium uppercase">encoder_id :</h3>

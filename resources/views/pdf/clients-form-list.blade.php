    ...
    <table style="width:100%" class="table-bordered">
        ...
        <tr style="font-size:9pt;">
            <td class="table-bordered center" width="20%">
                <img width="180px" src="{{ $item['photo'] }}" alt="Strandee photo"
                    class="">
            </td>
            <td class="table-bordered center" width="80%">
                <table>
                    <tr>
                        <td width="100px" style="border:0px">FULLNAME :</td>
                        <td style="border:0px">{{ $item['fullname'] }}</td>
                    </tr>
                    <tr>
                        <td style="border:0px">BIRTHDATE :</td>
                        <td style="border:0px">{{ $item['birthdate'] }}</td>
                    </tr>
                    <tr>
                        <td style="border:0px">SEX :</td>
                        <td style="border:0px">{{ $item['gender'] }}</td>
                    </tr>
                    <tr>
                        <td style="border:0px">CATEGORY :</td>
                        <td style="border:0px">{{ $item['category'] }}</td>
                    </tr>
                    <tr>
                        <td style="border:0px">BARANGAY :</td>
                        <td style="border:0px">{{ $item['barangay'] }}</td>
                    </tr>
                    <tr>
                        <td style="border:0px">CONTACT NO. :</td>
                        <td style="border:0px">{{ $item['contact'] }}</td>
                    </tr>
                </table>
            </td>
        </tr>
